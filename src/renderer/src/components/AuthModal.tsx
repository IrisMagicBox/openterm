  ...
  return (
    <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-md z-[100] flex items-center justify-center p-6 animate-in fade-in duration-500">
      <div className="bg-white w-full max-w-lg rounded-[40px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)] overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-8 duration-500">
        <div className="p-10">
          <div className={`w-20 h-20 ${risk.bg} ${risk.text} rounded-3xl flex items-center justify-center mb-8 shadow-sm border ${risk.border}`}>
            {risk.icon}
          </div>
          ...
          <div className={`rounded-3xl p-6 mb-8 border ${risk.border} ${risk.bg} bg-opacity-50`}>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[10px] font-bold text-gray-400 opacity-60">策略引擎评估报告</span>
            </div>
          ...
          <div className="bg-gray-900 rounded-[32px] p-7 mb-10 shadow-2xl border border-gray-800 relative group">
        ...
        <div className="px-10 py-5 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-gray-400 font-black tracking-widest">HITL 实时保护中</span>
            </div>
            <span className="text-[10px] text-gray-400 font-black tracking-widest opacity-40">OpenTerm SECURITY</span>
        </div>
      </div>
    </div>
  )
